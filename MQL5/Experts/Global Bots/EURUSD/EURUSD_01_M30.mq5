...
input string CustomComment = "Strategy_5_66_134";
...
input double ProfitTarget1 = 14;        //ProfitTarget1
input double StopLoss1 = 29;        //StopLoss1
input double TrailingStop1 = 50;        //TrailingStop1
input double TrailingActCef1 = 1.1;        //TrailingActCef1
...
#define MTKELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqMTKeltnerChannel", MTKeltnerChannelPrd1, 2.3)
#define SMMA_1 1     //iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_OPEN)
...
string sqStrategyName = "Strategy 5.66.134";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsFalling("sqWeekly(NULL,0,\"High\", 3)", 2, true, 0 + 1, 0))
      &&   (NormalizeDouble((double) sqDaily(NULL,0, "High", 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(MTKELTNERCHANNEL_1, 0, 2), 6)));

     ShortEntrySignal = ((sqIsRising("sqWeekly(NULL,0,\"Low\", 3)", 2, true, 0 + 1, 0))
      &&   (NormalizeDouble((double) sqDaily(NULL,0, "Low", 3), 6) < NormalizeDouble((double) sqGetIndicatorValue(MTKELTNERCHANNEL_1, 1, 2), 6)));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 185);
...
bool initIndicators(){
   ...
   indicatorHandles[MTKELTNERCHANNEL_1] = iCustom(NULL,0, "SqMTKeltnerChannel", MTKeltnerChannelPrd1, 2.3);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMMA_1] = iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_OPEN);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqWeekly(NULL,0,\"High\", 3)") {
          return   sqWeekly(NULL,0, "High", shift + 3);
      }
      if(id == "sqWeekly(NULL,0,\"Low\", 3)") {
          return   sqWeekly(NULL,0, "Low", shift + 3);
      }
