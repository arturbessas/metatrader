...
input string CustomComment = "Strategy_3_52_118";
...
input int BPChangesPeriod1 = 189;        //BPChangesPeriod1
...
input int BiggestRangePeriod1 = 14;        //BiggestRangePeriod1
...
#define BEARSPOWER_1 0     //iCustom(NULL,0, "SqBearsPower", BPChangesPeriod1, PRICE_CLOSE)
#define BULLSPOWER_1 1     //iCustom(NULL,0, "SqBullsPower", BPChangesPeriod1, PRICE_CLOSE)
#define LOWEST_1 2     //iCustom(NULL,0, "SqLowest", Period1, PRICE_OPEN)
#define HIGHEST_1 3     //iCustom(NULL,0, "SqHighest", Period1, PRICE_OPEN)
...
string sqStrategyName = "Strategy 3.52.118";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsFalling("sqClose(NULL,0, 3)", 2, false, 0 + 1, 0))
      &&   changesDown(BEARSPOWER_1, 1));

     ShortEntrySignal = ((sqIsRising("sqClose(NULL,0, 3)", 2, false, 0 + 1, 0))
      &&   changesUp(BULLSPOWER_1, 1));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 2) - (PriceEntryMult1 * sqBiggestRange("NULL",0, BiggestRangePeriod1, 1))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 2) + (PriceEntryMult1 * sqBiggestRange("NULL",0, BiggestRangePeriod1, 1))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BEARSPOWER_1] = iCustom(NULL,0, "SqBearsPower", BPChangesPeriod1, PRICE_CLOSE);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqClose(NULL,0, 3)") {
          return   sqClose(NULL,0, shift + 3);
      }
