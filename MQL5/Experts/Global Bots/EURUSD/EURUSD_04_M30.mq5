...
input string CustomComment = "Strategy_5_15_126";
...
#define KAUFMANEFFICIENCYRATIO_1 0     //iCustom(NULL,0,"SqEfficiencyRatio",KaufmanEffRtoPrd1)
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", Period1, PRICE_TYPICAL)
#define MTATR_1 2     //iATR(NULL,0, MTATRPeriod1)
#define LOWEST_1 3     //iCustom(NULL,0, "SqLowest", Period1, PRICE_TYPICAL)
...
string sqStrategyName = "Strategy 5.15.126";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqClose(NULL,0, 1), 6) < NormalizeDouble((double) sqMonthly(NULL,0, "Low", 3), 6));

     ShortEntrySignal = (NormalizeDouble((double) sqClose(NULL,0, 1), 6) > NormalizeDouble((double) sqMonthly(NULL,0, "High", 3), 6));

     LongExitSignal = ((sqIsRising(KAUFMANEFFICIENCYRATIO_1, 2, true, 3 + 2, 0))
      &&   (sqIsRising("sqHigh(NULL,0, 2)", 4, true, 0 + 3, 0)));

     ShortExitSignal = ((sqIsFalling(KAUFMANEFFICIENCYRATIO_1, 2, true, 3 + 2, 0))
      &&   (sqIsFalling("sqLow(NULL,0, 2)", 4, true, 0 + 3, 0)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 1) - (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 3))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 1) + (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 3))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[KAUFMANEFFICIENCYRATIO_1] = iCustom(NULL,0,"SqEfficiencyRatio",KaufmanEffRtoPrd1);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqHigh(NULL,0, 2)") {
          return   sqHigh(NULL,0, shift + 2);
      }
      if(id == "sqLow(NULL,0, 2)") {
          return   sqLow(NULL,0, shift + 2);
      }
