...
input string CustomComment = "Strategy_4_17_161";
...
input double MoveSL2BECoef1 = 4;        //MoveSL2BECoef1
input double ProfitTarget1 = 220;        //ProfitTarget1
input double StopLoss1 = 110;        //StopLoss1
...
#define ATR_1 0     //iCustom(NULL, 0, "SqATR", 37)
...
string sqStrategyName = "Strategy 4.17.161";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetAsk("Current"), 6) < NormalizeDouble((double) sqDaily(NULL,0, "Low", 1), 6));

     ShortEntrySignal = (NormalizeDouble((double) sqGetBid("Current"), 6) > NormalizeDouble((double) sqDaily(NULL,0, "High", 1), 6));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "Low", 2) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqDaily(NULL,0, "High", 2) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
