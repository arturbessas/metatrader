//+------------------------------------------------------------------+
//| Strategy 5.41.109 EA
//|
//|    Generated by StrategyQuant X Build 138 for MetaTrader5 (hedged)
//|    Generated at 05/31/2024 11:49
//| 
//|    Backtested on EURUSD_M1 / M30, 2023.01.01 - 2024.05.23 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_5_41_109";
...
input int AroonPeriod1 = 20;        //AroonPeriod1
input int MACDFast1 = 8;        //MACDFast1
input int MACDSlow1 = 26;        //MACDSlow1
input int MACDSmooth1 = 9;        //MACDSmooth1
input double PriceEntryMult1 = 0.9;        //PriceEntryMult1
input int ExitAfterBars1 = 22;        //ExitAfterBars1
input double MoveSL2BECoef1 = 4.6;        //MoveSL2BECoef1
input double StopLossCoef1 = 2.6;        //StopLossCoef1
input double TrailingStop1 = 70;        //TrailingStop1
input double TrailingActivation1 = 40;        //TrailingActivation1
...
#define AROON_1 0     //iCustom(NULL,0, "SqAroon", AroonPeriod1, 0)
#define MACD_1 1     //iMACD(NULL,0, MACDFast1, MACDSlow1, MACDSmooth1, PRICE_CLOSE)
#define BOLLINGERBANDS_1 2     //iBands(NULL,0, BBRangePeriod1, 0, 1.9, PRICE_CLOSE)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 57)
#define ATR_2 4     //iCustom(NULL, 0, "SqATR", 20)
...
string sqStrategyName = "Strategy 5.41.109";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsFalling(AROON_1, 2, false, 1 + 3, 1));

     ShortEntrySignal = (sqIsRising(AROON_1, 2, false, 1 + 3, 1));

     LongExitSignal = (((sqIsRising(MACD_1, 3, false, 3 + 1, 1))
      &&   (sqIsFalling("sqMonthly(NULL,0,\"Low\", 2)", 4, false, 0 + 3, 0)))
      &&   (sqIsFalling("sqDaily(NULL,0,\"Low\", 2)", 4, true, 0 + 3, 0)));

     ShortExitSignal = (((sqIsFalling(MACD_1, 3, false, 3 + 1, 1))
      &&   (sqIsRising("sqMonthly(NULL,0,\"High\", 2)", 4, false, 0 + 3, 0)))
      &&   (sqIsRising("sqDaily(NULL,0,\"High\", 2)", 4, true, 0 + 3, 0)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetAsk("Current") + (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 2)-sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 2)))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetBid("Current") - (PriceEntryMult1 * (sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 2)-sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 2)))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[AROON_1] = iCustom(NULL,0, "SqAroon", AroonPeriod1, 0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MACD_1] = iMACD(NULL,0, MACDFast1, MACDSlow1, MACDSmooth1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBRangePeriod1, 0, 1.9, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 57);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqMonthly(NULL,0,\"Low\", 2)") {
          return   sqMonthly(NULL,0, "Low", shift + 2);
      }
      if(id == "sqDaily(NULL,0,\"Low\", 2)") {
          return   sqDaily(NULL,0, "Low", shift + 2);
      }
      if(id == "sqMonthly(NULL,0,\"High\", 2)") {
          return   sqMonthly(NULL,0, "High", shift + 2);
      }
      if(id == "sqDaily(NULL,0,\"High\", 2)") {
          return   sqDaily(NULL,0, "High", shift + 2);
      }
