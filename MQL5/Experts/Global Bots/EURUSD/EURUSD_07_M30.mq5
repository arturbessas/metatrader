...
input string CustomComment = "Strategy_2_60_113";
...
input int BPChangesPeriod1 = 14;        //BPChangesPeriod1
input double ProfitTarget1 = 29;        //ProfitTarget1
input double StopLoss1 = 29;        //StopLoss1
input double TrailingStop1 = 50;        //TrailingStop1
input double TrailingActCef1 = 3.1;        //TrailingActCef1
...
#define BEARSPOWER_1 0     //iCustom(NULL,0, "SqBearsPower", BPChangesPeriod1, PRICE_WEIGHTED)
#define BULLSPOWER_1 1     //iCustom(NULL,0, "SqBullsPower", BPChangesPeriod1, PRICE_WEIGHTED)
#define SMA_1 2     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_TYPICAL)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 182)
...
string sqStrategyName = "Strategy 2.60.113";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (changesDown(BEARSPOWER_1, 2)
      &&   (sqIsFalling("sqWeekly(NULL,0,\"High\", 1)", 2, false, 0 + 3, 0)));

     ShortEntrySignal = (changesUp(BULLSPOWER_1, 2)
      &&   (sqIsRising("sqWeekly(NULL,0,\"Low\", 1)", 2, false, 0 + 3, 0)));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 80);
...
bool initIndicators(){
   ...
   indicatorHandles[BEARSPOWER_1] = iCustom(NULL,0, "SqBearsPower", BPChangesPeriod1, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BULLSPOWER_1] = iCustom(NULL,0, "SqBullsPower", BPChangesPeriod1, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[SMA_1] = iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_TYPICAL);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 182);
...
double sqGetExpressionByIdentification(string id, int shift) {
      if(id == "sqWeekly(NULL,0,\"High\", 1)") {
          return   sqWeekly(NULL,0, "High", shift + 1);
      }
      if(id == "sqWeekly(NULL,0,\"Low\", 1)") {
          return   sqWeekly(NULL,0, "Low", shift + 1);
      }
