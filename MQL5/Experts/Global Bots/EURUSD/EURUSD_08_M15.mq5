...
//| 
//|    Backtested on EURUSD_M1 / M15, 2023.01.01 - 2024.05.23 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_6_9_102";
...
#define MTKELTNERCHANNEL_1 1     //iCustom(NULL,0, "SqMTKeltnerChannel", MTKeltnerChannelPrd1, 2.3)
...
string sqStrategyName = "Strategy 6.9.102";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (crossesUp(AWESOMEOSCILLATOR_1, 3, 0.0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(MTKELTNERCHANNEL_1, 1, 3), 6) < NormalizeDouble((double) sqMonthly(NULL,0, "Low", 2), 6)));

     ShortEntrySignal = (crossesDown(AWESOMEOSCILLATOR_1, 3, 0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(MTKELTNERCHANNEL_1, 0, 3), 6) > NormalizeDouble((double) sqMonthly(NULL,0, "High", 2), 6)));
