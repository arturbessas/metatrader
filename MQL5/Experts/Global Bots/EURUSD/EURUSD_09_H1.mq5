...
input string CustomComment = "Strategy_5_76_133";
...
input int BBBarOpensPeriod1 = 10;        //BBBarOpensPeriod1
...
input int BiggestRangePeriod1 = 40;        //BiggestRangePeriod1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarOpensPeriod1, 0, 2.0, PRICE_WEIGHTED)
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBBarOpensPeriod1, 0, 2, PRICE_WEIGHTED)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 167)
...
string sqStrategyName = "Strategy 5.76.133";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 2) < sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 2+1));

     ShortEntrySignal = (sqOpen("NULL",0, 2) > sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 2+1));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetAsk("Current") + (PriceEntryMult1 * sqBiggestRange("NULL",0, BiggestRangePeriod1, 3))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 70);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetBid("Current") - (PriceEntryMult1 * sqBiggestRange("NULL",0, BiggestRangePeriod1, 3))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarOpensPeriod1, 0, 2.0, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBBarOpensPeriod1, 0, 2, PRICE_WEIGHTED);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 167);
