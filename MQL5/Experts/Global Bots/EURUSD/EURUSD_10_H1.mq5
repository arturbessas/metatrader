...
input string CustomComment = "Strategy_3_33_142";
...
#define BULLSPOWER_1 0     //iCustom(NULL,0, "SqBullsPower", BsPowerPeriod1, PRICE_CLOSE)
#define BEARSPOWER_1 1     //iCustom(NULL,0, "SqBearsPower", BsPowerPeriod1, PRICE_CLOSE)
#define PARABOLICSAR_1 2     //iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.1)
...
string sqStrategyName = "Strategy 3.33.142";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsFalling(BULLSPOWER_1, 4, false, 1 + 1, 0));

     ShortEntrySignal = (sqIsRising(BEARSPOWER_1, 4, false, 1 + 1, 0));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(PARABOLICSAR_1, 0, 3) + (PriceEntryMult1 * sqBarRange("NULL",0, 2))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 96);
...
bool initIndicators(){
   ...
   indicatorHandles[BULLSPOWER_1] = iCustom(NULL,0, "SqBullsPower", BsPowerPeriod1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BEARSPOWER_1] = iCustom(NULL,0, "SqBearsPower", BsPowerPeriod1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.1);
