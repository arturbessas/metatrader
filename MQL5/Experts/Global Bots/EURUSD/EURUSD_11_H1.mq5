...
input string CustomComment = "Strategy_6_69_160";
...
input int IchimokuTenkanPrd1 = 120;        //IchimokuTenkanPrd1
input int IchimokuKijunPeriod1 = 26;        //IchimokuKijunPeriod1
input int IchimokuSenkouPrd1 = 40;        //IchimokuSenkouPrd1
input double PriceEntryMult1 = 0.6;        //PriceEntryMult1
input double MoveSL2BECoef1 = 1.3;        //MoveSL2BECoef1
input double ProfitTarget1 = 19;        //ProfitTarget1
input double StopLoss1 = 29;        //StopLoss1
input double TrailingStopCoef1 = 2.2;        //TrailingStopCoef1
input double TrailingActCef1 = 2.3;        //TrailingActCef1
...
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 27)
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 57)
#define ATR_3 4     //iCustom(NULL, 0, "SqATR", 17)
...
string sqStrategyName = "Strategy 6.69.160";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqDaily(NULL,0, "Low", 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(ICHIMOKU_1, 0, 1), 6));

     ShortEntrySignal = (NormalizeDouble((double) sqDaily(NULL,0, "High", 3), 6) < NormalizeDouble((double) sqGetIndicatorValue(ICHIMOKU_1, 0, 1), 6));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqOpen(NULL,0, 3) - (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 1))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 166);
         ...
         sqSetTSActivation(_ticket, "TrailingActCef1 * sqGetIndicatorValue(ATR_3, 1)");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 27);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 57);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 17);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("TrailingActCef1 * sqGetIndicatorValue(ATR_3, 1)")) {
      return (TrailingActCef1 * sqGetIndicatorValue(ATR_3, 1));
   }
   if(idHash == sqStringHash("MoveSL2BECoef1 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (MoveSL2BECoef1 * sqGetIndicatorValue(ATR_1, 1));
   }
