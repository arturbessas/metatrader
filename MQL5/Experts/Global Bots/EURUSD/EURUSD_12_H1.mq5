...
input string CustomComment = "Strategy_4_77_195";
...
input int DIPlusPeriod1 = 20;        //DIPlusPeriod1
input int MACDMainFast1 = 12;        //MACDMainFast1
input int MACDMainSlow1 = 74;        //MACDMainSlow1
input int MACDMainSmooth1 = 9;        //MACDMainSmooth1
input int MACDMainFast2 = 24;        //MACDMainFast2
input int MACDMainSlow2 = 17;        //MACDMainSlow2
input int MACDMainSmooth2 = 16;        //MACDMainSmooth2
input double PriceEntryMult1 = 2.5;        //PriceEntryMult1
input double MoveSL2BECoef1 = 2.9;        //MoveSL2BECoef1
input double ProfitTarget1 = 19;        //ProfitTarget1
...
#define ADX_1 0     //iCustom(NULL,0, "SqADX", DIPlusPeriod1)
#define MACD_1 1     //iMACD(NULL,0, MACDMainFast1, MACDMainSlow1, MACDMainSmooth1, PRICE_CLOSE)
#define MACD_2 2     //iMACD(NULL,0, MACDMainFast2, MACDMainSlow2, MACDMainSmooth2, PRICE_CLOSE)
#define MTATR_1 3     //iATR(NULL,0, MTATRPeriod1)
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 32)
...
string sqStrategyName = "Strategy 4.77.195";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqGetIndicatorValue(ADX_1, 1, 3) < sqGetIndicatorValue(ADX_1, 2, 3);

     ShortEntrySignal = sqGetIndicatorValue(ADX_1, 1, 3) > sqGetIndicatorValue(ADX_1, 2, 3, 1);

     LongExitSignal = (sqGetIndicatorValue(MACD_1, 0, 1, true) > sqGetIndicatorValue(MACD_1, 1, 1, true)
      &&   sqGetIndicatorValue(MACD_2, 0, 1, true) > sqGetIndicatorValue(MACD_2, 1, 1, true));

     ShortExitSignal = (sqGetIndicatorValue(MACD_1, 0, 1, true) < sqGetIndicatorValue(MACD_1, 1, 1, true)
      &&   sqGetIndicatorValue(MACD_2, 0, 1, true) < sqGetIndicatorValue(MACD_2, 1, 1, true));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetBid("Current") + (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 3))), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetAsk("Current") - (PriceEntryMult1 * sqGetIndicatorValue(MTATR_1, 0, 3))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[ADX_1] = iCustom(NULL,0, "SqADX", DIPlusPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MACD_1] = iMACD(NULL,0, MACDMainFast1, MACDMainSlow1, MACDMainSmooth1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MACD_2] = iMACD(NULL,0, MACDMainFast2, MACDMainSlow2, MACDMainSmooth2, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTATR_1] = iATR(NULL,0, MTATRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 32);
