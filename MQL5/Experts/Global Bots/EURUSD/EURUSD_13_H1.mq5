//+------------------------------------------------------------------+
//| Strategy 2.18.172 EA
//|
//|    Generated by StrategyQuant X Build 138 for MetaTrader5 (hedged)
//|    Generated at 05/31/2024 11:48
//| 
//|    Backtested on EURUSD_M1 / H1, 2023.01.01 - 2024.05.23 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_2_18_172";
...
input int IchimokuTenkanPrd1 = 23;        //IchimokuTenkanPrd1
input int IchimokuKijunPeriod1 = 172;        //IchimokuKijunPeriod1
input int IchimokuSenkouPrd1 = 52;        //IchimokuSenkouPrd1
input int ReflexPeriod1 = 36;        //ReflexPeriod1
input int MomentumPeriod1 = 30;        //MomentumPeriod1
input double PriceEntryMult1 = 2.1;        //PriceEntryMult1
input int ExitAfterBars1 = 48;        //ExitAfterBars1
input double ProfitTarget1 = 24;        //ProfitTarget1
input double StopLoss1 = 29;        //StopLoss1
...
#define ICHIMOKU_1 0     //iCustom(NULL,0, "SqIchimoku", IchimokuTenkanPrd1, IchimokuKijunPeriod1, IchimokuSenkouPrd1)
#define REFLEX_1 1     //iCustom(NULL,0, "SqReflex", ReflexPeriod1)
#define MOMENTUM_1 2     //iMomentum(NULL,0, MomentumPeriod1, PRICE_CLOSE)
#define PARABOLICSAR_1 3     //iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.20)
#define PARABOLICSAR_2 4     //iCustom(NULL,0, "SqParabolicSAR", 0.02, 0.2)
...
string sqStrategyName = "Strategy 2.18.172";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (NormalizeDouble((double) sqGetAsk("Current"), 6) < NormalizeDouble((double) sqGetIndicatorValue(ICHIMOKU_1, 1, 1), 6));

     ShortEntrySignal = (NormalizeDouble((double) sqGetBid("Current"), 6) > NormalizeDouble((double) sqGetIndicatorValue(ICHIMOKU_1, 1, 1), 6));

     LongExitSignal = ((sqIsFalling(REFLEX_1, 4, false, 1 + 2, 0))
      &&   (sqIsRising(MOMENTUM_1, 4, false, 3 + 3, 0)));

     ShortExitSignal = ((sqIsRising(REFLEX_1, 4, false, 1 + 2, 0))
      &&   (sqIsFalling(MOMENTUM_1, 4, false, 3 + 3, 0)));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(PARABOLICSAR_1, 0, 2) + (PriceEntryMult1 * sqBarRange("NULL",0, 2))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 115);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(PARABOLICSAR_2, 0, 2) - (PriceEntryMult1 * sqBarRange("NULL",0, 2))), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[REFLEX_1] = iCustom(NULL,0, "SqReflex", ReflexPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOMENTUM_1] = iMomentum(NULL,0, MomentumPeriod1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.20);
