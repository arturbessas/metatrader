...
input string CustomComment = "Strategy_3_35_166";
...
input int BBerPeriod1 = 20;        //BBerPeriod1
...
input double StopLoss1 = 19;        //StopLoss1
input double TrailingStopCoef1 = 3.6;        //TrailingStopCoef1
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBerPeriod1, 0, 2.1, PRICE_LOW)
#define BOLLINGERBANDS_2 1     //iBands(NULL,0, BBerPeriod1, 0, 2.1, PRICE_HIGH)
#define BOLLINGERBANDS_3 2     //iBands(NULL,0, BollingerBandsPrd1, 0, 2.1, PRICE_CLOSE)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 37)
#define ATR_2 4     //iCustom(NULL, 0, "SqATR", 47)
...
string sqStrategyName = "Strategy 3.35.166";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1+1)>sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1));

     ShortEntrySignal = (sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 1+1)<sqGetIndicatorValue(BOLLINGERBANDS_2, 2, 1));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_3, 0 + 1, 1) + (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 193);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(BOLLINGERBANDS_3, 1 + 1, 1) - (PriceEntryMult1 * sqSmallestRange("NULL",0, SmallestRangePeriod1, 1))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBerPeriod1, 0, 2.1, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_2] = iBands(NULL,0, BBerPeriod1, 0, 2.1, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_3] = iBands(NULL,0, BollingerBandsPrd1, 0, 2.1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 37);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(NULL, 0, "SqATR", 47);
