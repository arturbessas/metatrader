...
input string CustomComment = "Strategy_4_46_182";
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BBBarOpensPeriod1, 0, 1.9, PRICE_WEIGHTED)
...
string sqStrategyName = "Strategy 4.46.182";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqOpen("NULL",0, 1) < sqGetIndicatorValue(BOLLINGERBANDS_1, 1, 1+1));

     ShortEntrySignal = (sqOpen("NULL",0, 1) > sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 1+1));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 181);
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBBarOpensPeriod1, 0, 1.9, PRICE_WEIGHTED);
