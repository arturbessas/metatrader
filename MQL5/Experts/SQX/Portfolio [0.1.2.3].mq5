//+------------------------------------------------------------------+
//| Portfolio [0.1.2.3] EA
//|
//|    Generated by StrategyQuant X Build 139 for MetaTrader5 (hedged)
//|    Generated at 05/25/2024 20:22
//| 
//|    Backtested on ETHUSD / M1, 2023.01.02 - 2024.05.24 
//+------------------------------------------------------------------+
...
input string CustomComment = "Portfolio_0_1_2_3";
...
input int CCIPeriod1 = 20;        //CCIPeriod1
input int ExitAfterBars1 = 11;        //ExitAfterBars1
input double ProfitTargetCoef1 = 2.6;        //ProfitTargetCoef1
...
#define AWESOMEOSCILLATOR_1 0     //iAO(NULL,0)
#define CCI_1 1     //iCustom(NULL,0, "SqCCI", CCIPeriod1, PRICE_CLOSE)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 20)
#define HEIKENASHI_1 3     //iCustom(NULL,0, "SqHeikenAshi")
...
string sqStrategyName = "Portfolio [0.1.2.3]";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqGetIndicatorValue(AWESOMEOSCILLATOR_1, 1) > 25.01;

     ShortEntrySignal = sqGetIndicatorValue(AWESOMEOSCILLATOR_1, 1) < -25.01;

     LongExitSignal = (sqGetIndicatorValue(CCI_1, 2+1)<sqGetIndicatorValue(CCI_1, 2));

     ShortExitSignal = (sqGetIndicatorValue(CCI_1, 2+1)>sqGetIndicatorValue(CCI_1, 2));
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqHeikenAshi("NULL",0, "Close", 1), "Current");
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 1, StopLoss1), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY_STOP, openPrice, 2, ProfitTargetCoef1 * sqGetIndicatorValue(ATR_1, 1)), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 16);
...
//------------------------
...
)
   {
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL_STOP, openPrice, 2, ProfitTargetCoef1 * sqGetIndicatorValue(ATR_1, 1)), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   indicatorHandles[AWESOMEOSCILLATOR_1] = iAO(NULL,0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[CCI_1] = iCustom(NULL,0, "SqCCI", CCIPeriod1, PRICE_CLOSE);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("ProfitTargetCoef1 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (ProfitTargetCoef1 * sqGetIndicatorValue(ATR_1, 1));
   }
