...
//| Portfolio EA
//|
//|    Generated by StrategyQuant X Build 139 for MetaTrader5 (hedged)
//|    Generated at 05/25/2024 21:10
//| 
//|    Backtested on ?? / ??, ?? - ?? 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 0.434";        //CustomComment
input string CustomComment2 = "Strategy 0.1269";        //CustomComment2
input int MagicNumber2 = 11112;        //MagicNumber2
bool LongEntrySignal2 = false;        //LongEntrySignal2
bool ShortEntrySignal2 = false;        //ShortEntrySignal2
bool LongExitSignal2 = false;        //LongExitSignal2
bool ShortExitSignal2 = false;        //ShortExitSignal2
input string CustomComment3 = "Strategy 0.1305";        //CustomComment3
input int MagicNumber3 = 11113;        //MagicNumber3
bool LongEntrySignal3 = false;        //LongEntrySignal3
bool ShortEntrySignal3 = false;        //ShortEntrySignal3
bool LongExitSignal3 = false;        //LongExitSignal3
bool ShortExitSignal3 = false;        //ShortExitSignal3
input string CustomComment4 = "Strategy 0.1561";        //CustomComment4
input int MagicNumber4 = 11114;        //MagicNumber4
bool LongEntrySignal4 = false;        //LongEntrySignal4
bool ShortEntrySignal4 = false;        //ShortEntrySignal4
bool LongExitSignal4 = false;        //LongExitSignal4
bool ShortExitSignal4 = false;        //ShortExitSignal4
input int MABarOpensAftOpnPrd1 = 20;        //MABarOpensAftOpnPrd1
input double ProfitTarget1 = 2;        //ProfitTarget1
input double StopLoss1 = 7;        //StopLoss1
input int RSIChangesPeriod1 = 40;        //RSIChangesPeriod1
input int IchimokuTnkKjnCrsBshTnkPrd1 = 9;        //IchimokuTnkKjnCrsBshTnkPrd1
input int IchimokuTnkKjnCrsBshKjnPrd1 = 26;        //IchimokuTnkKjnCrsBshKjnPrd1
input int IchimokuTnkKjnCrsBshSnkPrd1 = 52;        //IchimokuTnkKjnCrsBshSnkPrd1
input double ProfitTarget2 = 9;        //ProfitTarget2
input double StopLoss2 = 4;        //StopLoss2
input int StdDevChangesUpPrd1 = 50;        //StdDevChangesUpPrd1
input int MABarOpensAftOpnPrd2 = 50;        //MABarOpensAftOpnPrd2
input double StopLoss3 = 6;        //StopLoss3
input int ADXRisingPeriod1 = 20;        //ADXRisingPeriod1
input double PriceEntryMult1 = 1.5;        //PriceEntryMult1
input int Period1 = 50;        //Period1
...
input string Subchart1Symbol = "ETHUSD";
input int Subchart1Timeframe = 1;
...
#define AWESOMEOSCILLATOR_1 0     //iAO(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe))
#define MOVINGAVERAGE_1 1     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), MABarOpensAftOpnPrd1, 0, MODE_LWMA, PRICE_CLOSE)
#define RSI_1 2     //iRSI(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), RSIChangesPeriod1, PRICE_HIGH)
#define ICHIMOKU_1 3     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqIchimoku", IchimokuTnkKjnCrsBshTnkPrd1, IchimokuTnkKjnCrsBshKjnPrd1, IchimokuTnkKjnCrsBshSnkPrd1)
#define RSI_2 4     //iRSI(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), RSIChangesPeriod1, PRICE_LOW)
#define STDDEV_1 5     //iStdDev(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), StdDevChangesUpPrd1, 0, MODE_SMA, PRICE_LOW)
#define MOVINGAVERAGE_2 6     //iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), MABarOpensAftOpnPrd2, 0, MODE_SMA, PRICE_CLOSE)
#define STDDEV_2 7     //iStdDev(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), StdDevChangesUpPrd1, 0, MODE_SMA, PRICE_HIGH)
#define ADX_1 8     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", ADXRisingPeriod1)
#define LOWEST_1 9     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqLowest", Period1, PRICE_CLOSE)
#define ATR_1 10     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", ATRPeriod1)
#define HIGHEST_1 11     //iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHighest", Period1, PRICE_CLOSE)
#define HEIKENASHI_1 12     //255
#define HEIKENASHI_2 13     //255
...
string sqStrategyName = "Portfolio";
...
void OnTick() {
   ...
   sqManagePositions(MagicNumber2);
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (changesUp(AWESOMEOSCILLATOR_1, 3)
      &&   (sqOpen(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 3+1) < sqGetIndicatorValue(MOVINGAVERAGE_1, 0, 3+1, true) && sqOpen(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 3) > sqGetIndicatorValue(MOVINGAVERAGE_1, 0, 3+1, true)));

     ShortEntrySignal = (changesDown(AWESOMEOSCILLATOR_1, 3)
      &&   (sqOpen(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 1) > sqGetIndicatorValue(MOVINGAVERAGE_1, 0, 3+1, true) && sqOpen(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 3) < sqGetIndicatorValue(MOVINGAVERAGE_1, 0, 3+1, true)));
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, StopLoss1), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, ProfitTarget1), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
      
      _ticket = openPosition(
         ORDER_TYPE_BUY, // Order type
         "Subchart1Symbol", // Symbol
         size, // Size
         openPrice, // Price
         sl, // Stop Loss
         pt, // Profit Target   
         correctSlippage(sqMaxEntrySlippage, "Subchart1Symbol"), // Max deviation
         "Strategy 0.434", // Comment
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, StopLoss1), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, ProfitTarget1), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
      
      _ticket = openPosition(
         ORDER_TYPE_SELL, // Order type
         "Subchart1Symbol", // Symbol
         size, // Size
         openPrice, // Price
         sl, // Stop Loss
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((LongExitSignal
      &&   (!(LongEntrySignal)))
      &&   sqMarketPositionIsLong(MagicNumber, "Subchart1Symbol", "Strategy 0.434"))
)
   {
      // Action #1
        // Close all positions
      sqCloseAllPositions("Subchart1Symbol", MagicNumber, 1, "Strategy 0.434");
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((ShortExitSignal
      &&   (!(ShortEntrySignal)))
      &&   sqMarketPositionIsShort(MagicNumber, "Subchart1Symbol", "Strategy 0.434"))
)
   {
      // Action #1
        // Close all positions
...
//------------------------
// Rule: Trading signals2
//------------------------
if (_sqIsBarOpen == true) {
     // init signals only on bar open 
     LongEntrySignal2 = (changesUp(RSI_1, 3)
      &&   sqIchimokuTenkanKijunCross(1, correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), ICHIMOKU_1, 3, 2));

     ShortEntrySignal2 = (changesDown(RSI_2, 3)
      &&   sqIchimokuTenkanKijunCross(-1, correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), ICHIMOKU_1, 3, 2));

     LongExitSignal2 = false;

     ShortExitSignal2 = false;
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, StopLoss2), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, ProfitTarget2), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, StopLoss2), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, ProfitTarget2), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((LongExitSignal2
      &&   (!(LongEntrySignal2)))
      &&   sqMarketPositionIsLong(MagicNumber2, "Subchart1Symbol", "Strategy 0.1269"))
)
   {
      // Action #1
        // Close all positions
      sqCloseAllPositions("Subchart1Symbol", MagicNumber2, 1, "Strategy 0.1269");
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((ShortExitSignal2
      &&   (!(ShortEntrySignal2)))
      &&   sqMarketPositionIsShort(MagicNumber2, "Subchart1Symbol", "Strategy 0.1269"))
)
   {
      // Action #1
        // Close all positions
...
//------------------------
// Rule: Trading signals3
//------------------------
if (_sqIsBarOpen == true) {
     // init signals only on bar open 
     LongEntrySignal3 = (changesUp(STDDEV_1, 1)
      &&   (sqOpen(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 3+1) < sqGetIndicatorValue(MOVINGAVERAGE_2, 0, 3+1, true) && sqOpen(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 3) > sqGetIndicatorValue(MOVINGAVERAGE_2, 0, 3+1, true)));

     ShortEntrySignal3 = (changesUp(STDDEV_2, 1)
      &&   (sqOpen(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 1) > sqGetIndicatorValue(MOVINGAVERAGE_2, 0, 3+1, true) && sqOpen(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), 3) < sqGetIndicatorValue(MOVINGAVERAGE_2, 0, 3+1, true)));

     LongExitSignal3 = false;

     ShortExitSignal3 = false;
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, StopLoss3), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Subchart1Symbol", ORDER_TYPE_BUY, openPrice, 1, ProfitTarget2), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
      ...
      _ticket = openPosition(
         ...
         pt, // Profit Target   
         correctSlippage(sqMaxEntrySlippage, "Subchart1Symbol"), // Max deviation
         "Strategy 0.1305", // Comment
         MagicNumber3, // MagicNumber
         ExpirationTime, // Expiration time
         false, // Replace existing (only for pending orders)
         false  // Allow duplicate trades
      );
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, StopLoss3), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL, openPrice, 1, ProfitTarget2), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((LongExitSignal3
      &&   (!(LongEntrySignal3)))
      &&   sqMarketPositionIsLong(MagicNumber3, "Subchart1Symbol", "Strategy 0.1305"))
)
   {
      // Action #1
        // Close all positions
      sqCloseAllPositions("Subchart1Symbol", MagicNumber3, 1, "Strategy 0.1305");
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((ShortExitSignal3
      &&   (!(ShortEntrySignal3)))
      &&   sqMarketPositionIsShort(MagicNumber3, "Subchart1Symbol", "Strategy 0.1305"))
)
   {
      // Action #1
        // Close all positions
...
//------------------------
// Rule: Trading signals4
//------------------------
if (_sqIsBarOpen == true) {
     // init signals only on bar open 
     LongEntrySignal4 = sqIsRising(ADX_1, 2, false, 2);

     ShortEntrySignal4 = sqIsRising(ADX_1, 2, false, 2);

     LongExitSignal4 = false;

     ShortExitSignal4 = false;
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(LOWEST_1, 0, 2) - (PriceEntryMult1 * sqGetIndicatorValue(ATR_1, 0, 1))), "Subchart1Symbol");
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_BUY_STOP, openPrice, 1, StopLoss3), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Subchart1Symbol", ORDER_TYPE_BUY_STOP, openPrice, 1, ProfitTarget2), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
      ...
      _ticket = openPosition(
         ...
         pt, // Profit Target   
         correctSlippage(sqMaxEntrySlippage, "Subchart1Symbol"), // Max deviation
         "Strategy 0.1561", // Comment
         MagicNumber4, // MagicNumber
         ExpirationTime, // Expiration time
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice((sqGetIndicatorValue(HIGHEST_1, 0, 2) + (PriceEntryMult1 * sqGetIndicatorValue(ATR_1, 0, 1))), "Subchart1Symbol");
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL_STOP, openPrice, 1, StopLoss3), "Subchart1Symbol");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Subchart1Symbol", ORDER_TYPE_SELL_STOP, openPrice, 1, ProfitTarget2), "Subchart1Symbol");
      size = mmLots * mmMultiplier;
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((LongExitSignal4
      &&   (!(LongEntrySignal4)))
      &&   sqMarketPositionIsLong(MagicNumber4, "Subchart1Symbol", "Strategy 0.1561"))
)
   {
      // Action #1
        // Close all positions
      sqCloseAllPositions("Subchart1Symbol", MagicNumber4, 1, "Strategy 0.1561");
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((ShortExitSignal4
      &&   (!(ShortEntrySignal4)))
      &&   sqMarketPositionIsShort(MagicNumber4, "Subchart1Symbol", "Strategy 0.1561"))
)
   {
      // Action #1
        // Close all positions
...
bool checkComments(){
   ...
   if(StringLen(CustomComment2) > 30){
      Alert("Strategy initialization error - Comment CustomComment2 is longer than 30 characters");
      return false;
   }
   if(StringLen(CustomComment3) > 30){
      Alert("Strategy initialization error - Comment CustomComment3 is longer than 30 characters");
      return false;
   }
   if(StringLen(CustomComment4) > 30){
      Alert("Strategy initialization error - Comment CustomComment4 is longer than 30 characters");
      return false;
   }
   return true;
}
...
bool checkMagicNumber(ulong magicNo){
    ...
    if(magicNo == MagicNumber2){
         return true;
    }
    if(magicNo == MagicNumber3){
         return true;
    }
    if(magicNo == MagicNumber4){
         return true;
    }
    return false;
}
...
bool initIndicators(){
   ...
   indicatorHandles[AWESOMEOSCILLATOR_1] = iAO(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe));
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_1] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), MABarOpensAftOpnPrd1, 0, MODE_LWMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[RSI_1] = iRSI(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), RSIChangesPeriod1, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ICHIMOKU_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqIchimoku", IchimokuTnkKjnCrsBshTnkPrd1, IchimokuTnkKjnCrsBshKjnPrd1, IchimokuTnkKjnCrsBshSnkPrd1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[RSI_2] = iRSI(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), RSIChangesPeriod1, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[STDDEV_1] = iStdDev(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), StdDevChangesUpPrd1, 0, MODE_SMA, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_2] = iMA(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), MABarOpensAftOpnPrd2, 0, MODE_SMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[STDDEV_2] = iStdDev(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), StdDevChangesUpPrd1, 0, MODE_SMA, PRICE_HIGH);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ADX_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqADX", ADXRisingPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWEST_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqLowest", Period1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqATR", ATRPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HIGHEST_1] = iCustom(correctSymbol(Subchart1Symbol),TFMigrate(Subchart1Timeframe), "SqHighest", Period1, PRICE_CLOSE);
