...
input string CustomComment = "Strategy_0_1570";
...
input int StdDevRisingPeriod1 = 20;        //StdDevRisingPeriod1
...
#define STDDEV_1 0     //iStdDev(NULL,0, StdDevRisingPeriod1, 0, MODE_SMA, PRICE_LOW)
#define STDDEV_2 1     //iStdDev(NULL,0, StdDevRisingPeriod1, 0, MODE_SMA, PRICE_HIGH)
...
string sqStrategyName = "Strategy 0.1570";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = sqIsRising(STDDEV_1, 2, false, 3);

     ShortEntrySignal = sqIsRising(STDDEV_2, 2, false, 3);
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_BUY, openPrice, 1, StopLoss1), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_BUY, openPrice, 1, ProfitTarget1), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_SELL, openPrice, 1, StopLoss1), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_SELL, openPrice, 1, ProfitTarget1), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   indicatorHandles[STDDEV_1] = iStdDev(NULL,0, StdDevRisingPeriod1, 0, MODE_SMA, PRICE_LOW);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[STDDEV_2] = iStdDev(NULL,0, StdDevRisingPeriod1, 0, MODE_SMA, PRICE_HIGH);
