...
input string CustomComment = "Strategy_0_181";
...
input int StdDevChangesUpPrd1 = 30;        //StdDevChangesUpPrd1
input int OSMAChangesFastEMA1 = 12;        //OSMAChangesFastEMA1
input int OSMAChangesSlowEMA1 = 26;        //OSMAChangesSlowEMA1
input int OSMAChangesSgnPrd1 = 9;        //OSMAChangesSgnPrd1
input double PriceEntryMult1 = 2.6;        //PriceEntryMult1
input double ProfitTarget1 = 5;        //ProfitTarget1
input double StopLoss1 = 9;        //StopLoss1
input int SMAPeriod1 = 20;        //SMAPeriod1
...
#define STDDEV_1 0     //iStdDev(NULL,0, StdDevChangesUpPrd1, 0, MODE_SMA, PRICE_CLOSE)
#define OSMA_1 1     //iOsMA(NULL,0, OSMAChangesFastEMA1, OSMAChangesSlowEMA1, OSMAChangesSgnPrd1, PRICE_CLOSE)
#define SMA_1 2     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_WEIGHTED)
#define ATR_1 3     //iCustom(NULL,0, "SqATR", ATRPeriod1)
...
string sqStrategyName = "Strategy 0.181";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (changesUp(STDDEV_1, 2)
      &&   changesUp(OSMA_1, 3, 0));

     ShortEntrySignal = (changesUp(STDDEV_1, 2)
      &&   changesDown(OSMA_1, 3, 0));
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 11);
...
bool initIndicators(){
   ...
   indicatorHandles[STDDEV_1] = iStdDev(NULL,0, StdDevChangesUpPrd1, 0, MODE_SMA, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[OSMA_1] = iOsMA(NULL,0, OSMAChangesFastEMA1, OSMAChangesSlowEMA1, OSMAChangesSgnPrd1, PRICE_CLOSE);
