...
input string CustomComment = "Strategy_0_1993";
...
input int StochSlowDKPeriod1 = 21;        //StochSlowDKPeriod1
input int StochSlowDDPeriod1 = 7;        //StochSlowDDPeriod1
input int StochSlowDSlowing1 = 7;        //StochSlowDSlowing1
...
#define HIGHEST_1 1     //iCustom(NULL,0, "SqHighest", Period1, PRICE_OPEN)
...
string sqStrategyName = "Strategy 0.1993";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqGetIndicatorValue(STOCHASTIC_1, 1, 3)>30.0);

     ShortEntrySignal = (sqGetIndicatorValue(STOCHASTIC_1, 1, 3)<70);
...
//------------------------
...
)
   {
      ...
      if(_ticket > 0) {
         ...
         sqSetOrderExpiration(_ticket, 13);
