...
string headers = "ticket,magic_number,position_id,time_setup,type,state,time_done,symbol,volume_initial,volume_current,price_open,price_current,reason,comment";
   ...
   for(uint i=0;i<total_orders;i++)
     {
      ...
      string str_o_reason           =EnumToString((ENUM_ORDER_REASON)o_reason);
         ...
         //"ticket,magic_number,position_id,time_setup,type,state,time_done,symbol,volume_initial,volume_current,price_open,price_current,reason,comment"
