...
input string CustomComment = "_H1_Strategy_3_1_58";
...
#define AROON_1 0     //iCustom(NULL,0, "SqAroon", 54, 0)
#define ATR_1 1     //iCustom(NULL, 0, "SqATR", 65)
...
string sqStrategyName = "(H1) Strategy 3.1.58";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqIsRising(AROON_1, 17, true, 3 + 1, 0))
      &&   sqBullishEngulfing(NULL,0, 1));

     ShortEntrySignal = ((sqIsFalling(AROON_1, 17, true, 3 + 1, 0))
      &&   sqBearishEngulfing(NULL,0, 1));
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_BUY, openPrice, 1, 1.02), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_BUY, openPrice, 1, 3.65), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetMoveSL2BE(_ticket, "1.45 * sqGetIndicatorValue(ATR_1, 1)", SLPTTYPE_RANGE);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_SELL, openPrice, 1, 1.02), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_SELL, openPrice, 1, 3.65), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   indicatorHandles[AROON_1] = iCustom(NULL,0, "SqAroon", 54, 0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 65);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("1.45 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (1.45 * sqGetIndicatorValue(ATR_1, 1));
   }
   if(idHash == sqStringHash("1.45 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (1.45 * sqGetIndicatorValue(ATR_1, 1));
   }
