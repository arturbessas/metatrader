...
input string CustomComment = "_H1_Strategy_4_3_82";
...
#define BULLSPOWER_1 0     //iCustom(NULL,0, "SqBullsPower", 19, PRICE_CLOSE)
#define BEARSPOWER_1 1     //iCustom(NULL,0, "SqBearsPower", 19, PRICE_CLOSE)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 15)
...
string sqStrategyName = "(H1) Strategy 4.3.82";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((sqTimeHour(sqTime(NULL,0, 1)) < 2)
      &&   sqIsRising(BULLSPOWER_1, 2, false, 3));

     ShortEntrySignal = ((sqTimeHour(sqTime(NULL,0, 1)) < 2)
      &&   sqIsFalling(BEARSPOWER_1, 2, false, 3));
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_BUY, openPrice, 1, 1.84), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetMoveSL2BE(_ticket, "2.71 * sqGetIndicatorValue(ATR_1, 1)", SLPTTYPE_RANGE);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_SELL, openPrice, 1, 1.84), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BULLSPOWER_1] = iCustom(NULL,0, "SqBullsPower", 19, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BEARSPOWER_1] = iCustom(NULL,0, "SqBearsPower", 19, PRICE_CLOSE);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("2.71 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (2.71 * sqGetIndicatorValue(ATR_1, 1));
   }
   if(idHash == sqStringHash("2.71 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (2.71 * sqGetIndicatorValue(ATR_1, 1));
   }
