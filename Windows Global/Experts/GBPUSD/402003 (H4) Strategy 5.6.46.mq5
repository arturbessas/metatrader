...
input string CustomComment = "_H4_Strategy_5_6_46";
...
#define MACD_1 0     //iMACD(NULL,0, 5, 9, 4, PRICE_CLOSE)
#define BULLSPOWER_1 1     //iCustom(NULL,0, "SqBullsPower", 15, PRICE_CLOSE)
#define BEARSPOWER_1 2     //iCustom(NULL,0, "SqBearsPower", 15, PRICE_CLOSE)
#define MACD_2 3     //iMACD(NULL,0, 23, 50, 5, PRICE_CLOSE)
#define ATR_1 4     //iCustom(NULL, 0, "SqATR", 70)
#define ATR_2 5     //iCustom(NULL, 0, "SqATR", 40)
...
string sqStrategyName = "(H4) Strategy 5.6.46";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = (sqIsRising(MACD_1, 2, false, 1)
      &&   sqGetIndicatorValue(BULLSPOWER_1, 3) < 0.0);

     ShortEntrySignal = (sqIsFalling(MACD_1, 2, false, 1)
      &&   sqGetIndicatorValue(BEARSPOWER_1, 3) > 0);

     LongExitSignal = (sqGetIndicatorValue(MACD_2, 1)<-0.0);

     ShortExitSignal = (sqGetIndicatorValue(MACD_2, 1)>0);
...
//------------------------
...
)
   {
      ...
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_BUY, openPrice, 1, 1.45), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_BUY, openPrice, 1, 1.67), "Current");
      ...
      if(_ticket > 0) {
         ...
         sqSetTrailingStop(_ticket, "2.24 * sqGetIndicatorValue(ATR_1, 1)", SLPTTYPE_RANGE);
         sqSetTSActivation(_ticket, "3.23 * sqGetIndicatorValue(ATR_2, 1)");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLPercentLevel("Current", ORDER_TYPE_SELL, openPrice, 1, 1.45), "Current");
      pt = sqFixMarketPrice(sqGetPTPercentLevel("Current", ORDER_TYPE_SELL, openPrice, 1, 1.67), "Current");
      size = mmLots * mmMultiplier;
...
bool initIndicators(){
   ...
   indicatorHandles[MACD_1] = iMACD(NULL,0, 5, 9, 4, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BULLSPOWER_1] = iCustom(NULL,0, "SqBullsPower", 15, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BEARSPOWER_1] = iCustom(NULL,0, "SqBearsPower", 15, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MACD_2] = iMACD(NULL,0, 23, 50, 5, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 70);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("2.24 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (2.24 * sqGetIndicatorValue(ATR_1, 1));
   }
   if(idHash == sqStringHash("3.23 * sqGetIndicatorValue(ATR_2, 1)")) {
      return (3.23 * sqGetIndicatorValue(ATR_2, 1));
   }
   if(idHash == sqStringHash("2.24 * sqGetIndicatorValue(ATR_1, 1)")) {
      return (2.24 * sqGetIndicatorValue(ATR_1, 1));
   }
